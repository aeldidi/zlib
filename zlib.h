...
ZEXTERN int ZEXPORT deflateGetDictionary OF(
		(z_streamp strm, Bytef* dictionary, uInt* dictLength));
/*
...
ZEXTERN int ZEXPORT deflatePending OF(
		(z_streamp strm, unsigned* pending, int* bits));
/*
...
ZEXTERN int ZEXPORT inflateGetDictionary OF(
		(z_streamp strm, Bytef* dictionary, uInt* dictLength));
/*
...
ZEXTERN z_size_t ZEXPORT gzfread OF(
		(voidp buf, z_size_t size, z_size_t nitems, gzFile file));
/*
...
ZEXTERN z_size_t ZEXPORT gzfwrite OF(
		(voidpc buf, z_size_t size, z_size_t nitems, gzFile file));
/*
...
ZEXTERN uLong ZEXPORT adler32_z OF(
		(uLong adler, const Bytef* buf, z_size_t len));
/*
...
ZEXTERN int ZEXPORT inflateBackInit_ OF(
		(z_streamp strm, int windowBits, unsigned char FAR* window,
				const char* version, int stream_size));
#ifdef Z_PREFIX_SET
...
#ifndef Z_SOLO
ZEXTERN int ZEXPORTVA gzvprintf Z_ARG(
		(gzFile file, const char* format, va_list va));
#endif
#endif
